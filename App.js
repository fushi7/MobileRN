  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 10 }}>
        ...
        <TouchableOpacity style={{ width: 300, height: 200 }}>
          <Image source={require('assets/hqdefault.jpg')} style={{ width: '100%', height: '100%' }} />
        </TouchableOpacity>
        <TouchableOpacity style={{ width: 300, height: 200 }}>
          <Image source={require('assets/hq720.jpg')} style={{ width: '100%', height: '100%' }} />
        </TouchableOpacity>
      </ScrollView>
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 10 }}>
        ...
        <TouchableOpacity style={{ width: 300, height: 200, backgroundColor: '#44E690', borderRadius: 10 }}>
          <Image source={require('assets/Curso-de-UX-e-UI-Design.jpg')} style={{ width: '100%', height: '100%', borderRadius: 10 }} />
          <Text>Curso de UX e UI Design</Text>
        </TouchableOpacity>
        <TouchableOpacity style={{ width: 300, height: 200, backgroundColor: '#44E690', borderRadius: 10 }}>
          <Image source={require()} style={{ width: '100%', height: '100%', borderRadius: 10 }} />
      ...
      <ScrollView horizontal showsHorizontalScrollIndicator={false} contentContainerStyle={{ paddingHorizontal: 10 }}>
        ...
        <TouchableOpacity style={{ width: 300, height: 200, backgroundColor: '#44E690', borderRadius: 10 }}>
          <Image source={require('./imagens/hqdefault (1).jpg')} style={{ width: '100%', height: '100%', borderRadius: 10 }} />
          <Text>Python para iniciantes</Text>
        </TouchableOpacity>
      </ScrollView>
    </View>
